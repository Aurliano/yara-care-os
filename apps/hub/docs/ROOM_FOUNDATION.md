...
1. **Production path**: `addMigrations(MIGRATION_1_2, MIGRATION_2_3, MIGRATION_3_4, MIGRATION_4_5)` preserves existing installs.
...
Version 5 adds `direction` (`Outgoing` / `Incoming`) on that row.
